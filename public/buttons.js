(function() {
    var t, e, n, r, s, o, i, a, u, c, l, p, h, f, d, g, m, y, v, w, b, k, S, q, L, x, T, R, P, E, M, j, A, N, O, _, F, C, U, W, X, D, H, I, z, G, B, J, K, Q = [].slice, V = {}.hasOwnProperty, Y = function(t, e) {
        function n() {
            this.constructor = t
        }
        for (var r in e)
    ...
    k = function() {
        ...
        for (e = arguments[0],
        o = 0,
        i = (r = 2 <= arguments.length ? Q.call(arguments, 1) : []).length; i > o; o++)
            if (n = r[o])
                for (t in n)
                    V.call(n, t) && (s = n[t],
    ...
    q = function(t, e) {
        ...
        s = document.querySelector("[data-pace-" + t + "]")) {
            ...
            try {
                ...
                return r = t,
                "undefined" != typeof console && null !== console ? console.error("Error", r) : void 0
            }
        }
    }
    ,
    ...
    _ = function(t) {
        ...
        if (!T.length && E.ajax) {
            if ("socket" === t && E.ajax.trackWebSockets)
                return !0;
            if (e = t.toUpperCase(),
            Z.call(E.ajax.trackMethods, e) >= 0)
                return !0
        }
        return !1
    }
